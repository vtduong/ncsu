...
<div class="panel panel-default">
	<div class="panel-heading"  anim-type="collapse" anim-target="#ortho-menu">
		<h2 class="panel-title">Orthopedic</h2>
	</div>
	<div class="panel-body" id="ortho-menu">
		<ul class="nav nav-sidebar">
			<li><a href="/iTrust/auth/hcp/createOrthopedicOV.jsp">Create Orthopedic Office Visit</a></li>
			<li><a href="/iTrust/auth/hcp/viewOrthopedicOV.jsp">View Orthopedic Office Visits</a></li>
			<li><a href="/iTrust/auth/hcp/editOrthopedicOV.jsp">Edit Orthopedic Office Visit</a></li>
		</ul>
	</div>
</div>
