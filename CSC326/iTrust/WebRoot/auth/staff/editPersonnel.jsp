		...
		<td class="subHeaderVertical">
		 ...
		 Last Name:
		  ...
		  <select name="specialty">
		    <option value="none" <%= personnelForm.getSpecialty() == null ? "selected":"" %>></option>
		  	<option value="general physician" <%= ( personnelForm.getSpecialty() != null && personnelForm.getSpecialty().equalsIgnoreCase("general physicial") ) ? "selected":"" %>>General Physician</option>
		  	<option value="heart surgeon" <%= ( personnelForm.getSpecialty() != null && personnelForm.getSpecialty().equalsIgnoreCase("heart surgeon") ) ? "selected":"" %>>Heart Surgeon</option>
		  	<option value="ob/gyn" <%= ( personnelForm.getSpecialty() != null && personnelForm.getSpecialty().equalsIgnoreCase("ob/gyn") ) ? "selected":"" %>>OB/GYN</option>
		  	<option value="ophthalmologist" <%= ( personnelForm.getSpecialty() != null && personnelForm.getSpecialty().equalsIgnoreCase("opthalmologist") ) ? "selected":"" %>>Ophthalmologist</option>
		  	<option value="optometrist" <%= ( personnelForm.getSpecialty() != null && personnelForm.getSpecialty().equalsIgnoreCase("optometrist") ) ? "selected":"" %>>Optometrist</option>
		  	<option value="pediatrician" <%= ( personnelForm.getSpecialty() != null && personnelForm.getSpecialty().equalsIgnoreCase("pediatrician") ) ? "selected":"" %>>Pediatrician</option>
		  	<option value="surgeon" <%= ( personnelForm.getSpecialty() != null && personnelForm.getSpecialty().equalsIgnoreCase("surgeon") ) ? "selected":"" %>>Surgeon</option>
		  </select>
		  </td></tr>  
