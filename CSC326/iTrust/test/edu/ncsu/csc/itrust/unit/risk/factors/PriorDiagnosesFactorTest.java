...
//		PreparedStatement ps = null;
		try(
			...
			PreparedStatement ps = conn.prepareStatement("INSERT INTO officevisits(VisitDate, hcpid, PatientID, hospitalid) VALUES(?,9000000000, 2, '1')");
			PreparedStatement ps1 = conn.prepareStatement("INSERT INTO ovdiagnosis(VisitID, ICDCode) VALUES(?,?)");
			...
			)
		{
			...
			ps.executeUpdate();
			//ps.close();
			ps1.setLong(1, DBUtil.getLastInsert(conn));
			ps1.setDouble(2, icd);
			ps1.executeUpdate();
		}
