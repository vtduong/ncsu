...
//		PreparedStatement ps = null;
		try (
			...
			PreparedStatement ps = conn.prepareStatement("DROP TABLE IF EXISTS testincrement");
			PreparedStatement ps1 = conn.prepareStatement("CREATE TABLE testincrement(id integer auto_increment primary key)");
