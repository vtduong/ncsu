...
public class AddSurveyTest extends TestCase {
	...
	public void testAddSurveyData() throws Exception {
		...
		surveyBean.setWaitingRoomMinutes(30);
	...
	public void testAddSurveyData2() {
		SurveyBean surveyBean = new SurveyBean();
		...
		surveyBean.setWaitingRoomMinutes(33);
		...
		newBean = surveyDAO.getSurveyData(905);
	...
	public void testAddSurveyData3() throws Exception {
		...
		surveyBean.setWaitingRoomMinutes(2);
